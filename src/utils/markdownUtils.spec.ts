...
describe('markdownUtils', () => {
  describe('showdownTailwindExtentions', () => {
    ...
    it('should have h4 extension with correct class', () => {
      const h4Ext = showdownTailwindExtentions.find(
        (ext) => ext.replace.includes('h4')
      );
    ...
    it('should have ul extension with correct class', () => {
      const ulExt = showdownTailwindExtentions.find(
        (ext) => ext.replace.includes('ul')
      );
    ...
    it('should have hr extension with correct class', () => {
      const hrExt = showdownTailwindExtentions.find(
        (ext) => ext.replace.includes('hr')
      );
    ...
    it('should have p extension with correct class', () => {
      const pExt = showdownTailwindExtentions.find(
        (ext) => ext.replace.includes('p')
      );
